        ...
        self.event_rows.append(
            {
                **MARKERS,
                ...
                "context_size": len(snapshot.active_ids),
                "context_source_ids": json.dumps(sorted(snapshot.active_ids)),
                "context_winner_ids": json.dumps(sorted(snapshot.winner_ids)),
                "context_predicted_ids": json.dumps(sorted(snapshot.predicted_ids)),
                "context_burst_ids": json.dumps(sorted(snapshot.burst_ids)),
